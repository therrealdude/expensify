  ...
  _createClass(IndecisionApp, [{
    ...
    value: function render() {
      return React.createElement(
        ...
        React.createElement(RemoveAll, { options: this.state.options, handleDeleteOptions: this.handleDeleteOptions })
      );
    }
  }]);
...
var RemoveAll = function (_React$Component7) {
  ...
  function RemoveAll(props) {
    ...
    return _possibleConstructorReturn(this, (RemoveAll.__proto__ || Object.getPrototypeOf(RemoveAll)).call(this, props));
  }
...
ReactDOM.render(React.createElement(User, { name: 'Dan', age: '28' }), document.getElementById('app'));
